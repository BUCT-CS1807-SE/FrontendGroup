...
public class VideoCategoryResponse implements Serializable {
    ...
    public static class PageBean {
        ...
        private List<com.example.myapplication.entity.CategoryEntity> list;
        ...
        public List<com.example.myapplication.entity.CategoryEntity> getList() {
            return list;
        }

        public void setList(List<com.example.myapplication.entity.CategoryEntity> list) {
            this.list = list;
        }
    }
}
